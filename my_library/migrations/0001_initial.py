    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Дата последнего обновления')),
                ('name', models.CharField(max_length=40, verbose_name='Имя')),
                ('description', models.CharField(max_length=1000, verbose_name='Имя')),
                ...
                ('author', models.ManyToManyField(to='my_library.author')),
            ],
            options={
                'verbose_name': 'Книга',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books', models.ManyToManyField(blank=True, to='my_library.book')),
            ],
            options={
